          ...
          <div className="container">
            <div className="grid lg:grid-cols-7 grid-cols-1 gap-16 items-center">
              <div className="lg:col-span-3 order-2 lg:order-1 text-center sm:text-start">
                ...
                <p className="text-default-500">An AI based solution which automatically follow ups with your leads and convert into customers</p>
                <div className="flex gap-4 mt-16">
                  <button className="flex items-center">
                    <a href="#" className="bg-primary text-white rounded-md hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">
                      Know more
                    </a>
                  </button>
                  <button className="flex items-center">
                    <a href="#" className="border border-primary text-primary rounded-md hover:bg-primary hover:text-white hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">
                      Know more
                    </a>
                  </button>
                </div>
              ...
              <div className="lg:col-span-4 order-1 lg:order-2" data-aos="fade-left" data-aos-duration={1000}>
                <div>
                  <img src={startup} alt="startup-img" data-aos="fade-left" data-aos-duration={1000} />
                </div>
              </div>
            </div>
          </div>
