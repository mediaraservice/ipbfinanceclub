...
const Pricing = () => {
  return <>
      <section className="bg-gradient-to-r from-default-100/70 to-default-100/50 relative py-16 sm:py-24">
        ...
        <div className="py-5">
          <div className="container relative">
            <div className="text-center">
              <span className="text-xs bg-primary/10 text-primary/90 rounded-full px-2 py-1">Plans</span>
              <h1 className="text-3xl/tight font-medium mb-4 mt-5">Pricing</h1>
