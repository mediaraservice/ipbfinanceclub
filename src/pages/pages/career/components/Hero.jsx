...
const Hero = () => {
  return <>
      <section className="bg-gradient-to-t from-default-200/70 relative">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 items-center">
              <div className="order-2 lg:order-1">
                <div className="text-center lg:text-start">
                  ...
                  <p className="text-default-500 leading-relaxed lg:w-3/4">
                  ...
                  <div className="mt-10 flex items-center justify-center lg:justify-start">
                    <button className="flex items-center bg-black/70 text-white rounded-md text-sm font-semibold flex-none shadow shadow-black hover:shadow-lg hover:shadow-black/30 focus:shadow-none focus:outline focus:outline-black/50 px-8 py-3">
                      View All Openings <FaArrowRight className="ms-2" />
                    </button>
                  </div>
                </div>
              </div>
              <div className="order-1 lg:order-2" data-aos="zoom-in">
                <div className="grid grid-cols-2 items-center gap-6">
                  <div>
                    <img src={photo16} alt="photo-12" className="border-[6px] border-white bg-white shadow-md" />
                  </div>
                  <div>
                    <div className="grid grid-rows-2 items-center gap-6">
                      <div>
                        <img src={photo14} alt="photo-14" className="border-[6px] border-white bg-white shadow-md" />
                      </div>
                      <div>
                        <img src={photo15} alt="photo-15" className="border-[6px] border-white bg-white shadow-md" />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="absolute -bottom-1 w-full">
          <svg className="w-full h-full" viewBox="0 0 1440 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
