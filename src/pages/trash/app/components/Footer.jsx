  ...
  return <section className="py-10">
      <div className="container">
        <div className="text-center">
          <div>
            <h2 className="md:text-3xl text-xl font-semibold my-5">Start offering your users a better experience</h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 my-10">
              <Link to="">
                <img alt="google" width={192} height={57} src={google} className="w-48" />
              </Link>
              <Link to="">
                <img alt="store" width={192} height={57} src={store} className="w-48" />
              </Link>
            </div>
          </div>
          ...
          <div>
            <ul className="flex flex-wrap items-center justify-center gap-5">
              ...
              return <li key={idx} className="after:content-['-'] after:text-slate-500 after:font-extrabold">
            ...
            <p className="my-5">{new Date().getFullYear()} © Prompt. All rights reserved. Crafted by</p>
            <Link to="/">
              <img alt="logo" width={126} height={32} src={logoDark} className="h-8 mx-auto" />
            </Link>
          </div>
        </div>
      </div>
