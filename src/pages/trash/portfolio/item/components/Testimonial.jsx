            ...
            <div className="relative">
              ...
              <div id="swiper_one" className="swiper relative">
                ...
                disableOnInteraction: false
                  ...
                  {slidImages.map((item, idx) => <SwiperSlide className="p-10 border border-default-200 rounded-xl bg-white shadow" key={idx}>
                      ...
                      <div className="flex items-center gap-2">
                        <img src={item} alt="" className="h-10 w-10 rounded-full" />
                        <div>
